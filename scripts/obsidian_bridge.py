...
1. 【本地与在线双模知识库支持 (Local & Online Vaults)】：
   ...
   - 在线知识库：支持填入在线知识库 URL (如 https://llm.yangonly.com, REST API, WebDAV, SilverBullet)；
...
def print_bridge_status():
    ...
    print("  - 设置在线地址: python scripts/obsidian_bridge.py --set-online 'https://llm.yangonly.com'")
...
def main():
    ...
    parser.add_argument("--set-online", nargs="?", const="", help="设置在线知识库地址 (如 https://llm.yangonly.com，可留空)")
