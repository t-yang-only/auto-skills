...
> 全能旗舰级 AI 研发与多 Agent 协同总控中枢：深度融合多 Agent 牛马协同台账 (nm-skills v2.0)，自洽收拢 42 大顶流核心技能，提供排他防撞、自适应多根寻址与 SDLC 阶段感知流水线。
...
[![Zero Missing Members](https://img.shields.io/badge/Members-42%20Self--Contained-brightgreen.svg)]()
...
- **自洽收拢 42 个高星通用技能**：你只需输入任务意图，调度引擎将自动为你生成端到端的执行流水线，并严格保证各阶段的硬门禁！

---

## 🏗️ 架构与 42 大内置成员 (Architecture & Tools)
...
└── references/
    ├── capability-map.md   # 42 大成员能力全景映射表与冲突优先级
